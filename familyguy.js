(function () {
    ...
    function addMenu() {
        // Найпростіший спосіб — вставити елемент напряму в DOM меню
        ...
        item.on('hover:enter click', function () {
            Lampa.Activity.push({
                ...
                url:       'https://family-guy.mult-fan.tv'
            });
        });

        // Вставляємо в перший список меню
            ...
            for (var s = 24; s >= 1; s--) {
                (function (seasonNum) {
                    ...
                    card.on('hover:enter', function () {
                        Lampa.Activity.push({
                            url:       'https://family-guy.mult-fan.tv/season.php?id=' + seasonNum,
        ...
        this.create = function () {
            ...
            network.silent(object.url, function (html) {
                ...
                links.forEach(function (a) {
                    ...
                    card.on('hover:enter', function () {
                        Lampa.Activity.push({
                            url: 'https://family-guy.mult-fan.tv/page.php?id=' + id,
                            title: title,
                            component: 'fg_watch'
                        });
                    });
    ...
    // ---- СТАРТ ----
    // Чекаємо поки меню відрендериться в DOM, потім вставляємо кнопку
    Lampa.Listener.follow('menu', function (e) {
        if (e.type === 'end') addMenu();
    });
